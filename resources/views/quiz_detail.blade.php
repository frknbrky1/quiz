        ...
        <div class="card-body">
            ...
            <div class="row">
                                    ...
                                    <ul class="list-group">
                                        @foreach($quiz->topTen as $result)
                                            <li class="list-group-item d-flex justify-content-between align-items-center">
                                                ...
                                                <div>
                                                        <span
                                                            class="badge bg-success rounded-pill">{{$result->point}}</span>
                                                </div>
                                            </li>
                                        @endforeach
                                    </ul>
                ...
                <div class="col-md-8">
                    {{$quiz->description}}
                    @if($quiz->my_result)
                        <a href="{{route('quiz.join', $quiz->slug)}}" class="btn btn-warning btn-sm w-100 mt-2">Quizi
                            Görüntüle <i class="fas fa-eye"></i></a>
                    @else
                        <a href="{{route('quiz.join', $quiz->slug)}}" class="btn btn-success btn-sm w-100 mt-2">Quize
                            Katıl <i class="fas fa-sign-in-alt"></i></a>
                    @endif
                </div>
            </div>
            </p>
