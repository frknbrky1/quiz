<x-jet-action-section>
    ...
    <x-slot name="description">
        {{ __('İki faktörlü kimlik doğrulamasını kullanarak hesabınızın güvenliğini arttırınız.') }}
    </x-slot>
    ...
    <x-slot name="content">
        ...
        @if ($this->enabled)
            ...
            @if ($showingRecoveryCodes)
                <div class="mt-4 max-w-xl text-sm text-gray-600">
                    <p class="font-semibold">
                        {{ __('Bu kurtarma kodlarını güvenli bir yerde saklayın. İki faktörlü kimlik doğrulama cihazınız kaybolsa da, hesabınıza erişimi sağlamak için kullanılabilirler.') }}
                    </p>
                </div>
